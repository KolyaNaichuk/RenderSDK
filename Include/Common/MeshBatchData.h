...
public:
	...
	u32 GetNumMeshInstances() const { return m_MeshInstanceAABBs.size(); }
	const AxisAlignedBox* GetMeshInstanceAABBs() const { return m_MeshInstanceAABBs.data(); }
...
private:
	...
	std::vector<AxisAlignedBox> m_MeshInstanceAABBs;
