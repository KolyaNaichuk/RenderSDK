	...
	, m_pLightViewProjMatrixBuffer(nullptr)
{
	...
	UploadData(pRenderEnv, m_pLightBoundsBuffer, lightBoundsBufferDesc,
		D3D12_RESOURCE_STATE_NON_PIXEL_SHADER_RESOURCE, lightBounds.data(), m_NumLights * sizeof(Sphere));
