	...
	, m_pCommandSignature(nullptr)
{
	...
	m_pRootSignature = new D3DRootSignature(pRenderEnv->m_pDevice, &rootSignatureDesc, L"RenderTiledShadowMapPass::m_pRootSignature");
	...
	m_pPipelineState = new D3DPipelineState(pRenderEnv->m_pDevice, &pipelineStateDesc, L"RenderTiledShadowMapPass::m_pPipelineState");
	...
	m_pCommandSignature = new D3DCommandSignature(pRenderEnv->m_pDevice, m_pRootSignature, &commandSignatureDesc, L"RenderTiledShadowMapPass::m_pCommandSignature");
}
