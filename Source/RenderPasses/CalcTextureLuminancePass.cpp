...
CalcTextureLuminancePass::CalcTextureLuminancePass(D3DDevice* pDevice, DXGI_FORMAT rtvFormat, bool logLuminance)
	...
	, m_pPipelineState(nullptr)
{
	...
	m_pRootSignature = new D3DRootSignature(pDevice, &rootSignatureDesc, L"CalcTextureLuminancePass::m_pRootSignature");
	...
	m_pPipelineState = new D3DPipelineState(pDevice, &pipelineStateDesc, L"CalcTextureLuminancePass::m_pPipelineState");
	*/
}
...
void CalcTextureLuminancePass::Record(D3DCommandList* pCommandList, D3DCommandAllocator* pCommandAllocator,
