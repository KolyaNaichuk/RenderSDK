...
CreateTiledShadowMapCommandsPass::CreateTiledShadowMapCommandsPass(InitParams* pParams)
...
CreateTiledShadowMapCommandsPass::~CreateTiledShadowMapCommandsPass()
{
...
void CreateTiledShadowMapCommandsPass::Record(RenderParams* pParams)
{
...
void CreateTiledShadowMapCommandsPass::InitResources(InitParams* pParams)
{
	RenderEnv* pRenderEnv = pParams->m_pRenderEnv;
	...
	m_pArgumentBuffer = new Buffer(pRenderEnv, pRenderEnv->m_pDefaultHeapProps, &argumentBufferDesc,
		D3D12_RESOURCE_STATE_COPY_DEST, L"CreateTiledShadowMapCommandsPass::m_pArgumentBuffer");
	...
	if (pParams->m_MaxNumPointLights > 0)
	{
		...
		m_pNumPointLightMeshInstancesBuffer = new Buffer(pRenderEnv, pRenderEnv->m_pDefaultHeapProps, &numPointLightMeshInstancesBufferDesc,
			pParams->m_InputResourceStates.m_NumPointLightMeshInstancesBufferState, L"CreateTiledShadowMapCommandsPass::m_pNumPointLightMeshInstancesBuffer");
		...
		m_pPointLightIndexForMeshInstanceBuffer = new Buffer(pRenderEnv, pRenderEnv->m_pDefaultHeapProps, &pointLightIndexForMeshInstanceBufferDesc,
			pParams->m_InputResourceStates.m_PointLightIndexForMeshInstanceBufferState, L"CreateTiledShadowMapCommandsPass::m_pPointLightIndexForMeshInstanceBuffer");
		...
		m_pMeshInstanceIndexForPointLightBuffer = new Buffer(pRenderEnv, pRenderEnv->m_pDefaultHeapProps, &meshInstanceIndexForPointLightBufferDesc,
			pParams->m_InputResourceStates.m_MeshInstanceIndexForPointLightBufferState, L"CreateTiledShadowMapCommandsPass::m_pMeshInstanceIndexForPointLightBuffer");
		...
		m_pNumPointLightCommandsBuffer = new Buffer(pRenderEnv, pRenderEnv->m_pDefaultHeapProps, &numPointLightCommandsBufferDesc,
			pParams->m_InputResourceStates.m_NumPointLightCommandsBufferState, L"CreateTiledShadowMapCommandsPass::m_pNumPointLightCommandsBuffer");
		...
		m_pPointLightCommandBuffer = new Buffer(pRenderEnv, pRenderEnv->m_pDefaultHeapProps, &pointLightCommandBufferDesc,
			pParams->m_InputResourceStates.m_PointLightCommandBufferState, L"CreateTiledShadowMapCommandsPass::m_pPointLightCommandBuffer");
	}
	...
	if (pParams->m_MaxNumSpotLights > 0)
	{
		...
		m_pNumSpotLightMeshInstancesBuffer = new Buffer(pRenderEnv, pRenderEnv->m_pDefaultHeapProps, &numSpotLightMeshInstancesBufferDesc,
			pParams->m_InputResourceStates.m_NumSpotLightMeshInstancesBufferState, L"CreateTiledShadowMapCommandsPass::m_pNumSpotLightMeshInstancesBuffer");
		...
		m_pSpotLightIndexForMeshInstanceBuffer = new Buffer(pRenderEnv, pRenderEnv->m_pDefaultHeapProps, &spotLightIndexForMeshInstanceBufferDesc,
			pParams->m_InputResourceStates.m_SpotLightIndexForMeshInstanceBufferState, L"CreateTiledShadowMapCommandsPass::m_pSpotLightIndexForMeshInstanceBuffer");
		...
		m_pMeshInstanceIndexForSpotLightBuffer = new Buffer(pRenderEnv, pRenderEnv->m_pDefaultHeapProps, &meshInstanceIndexForSpotLightBufferDesc,
			pParams->m_InputResourceStates.m_MeshInstanceIndexForSpotLightBufferState, L"CreateTiledShadowMapCommandsPass::m_pMeshInstanceIndexForSpotLightBuffer");
		...
		m_pNumSpotLightCommandsBuffer = new Buffer(pRenderEnv, pRenderEnv->m_pDefaultHeapProps, &numSpotLightCommandsBufferDesc,
			pParams->m_InputResourceStates.m_NumSpotLightCommandsBufferState, L"CreateTiledShadowMapCommandsPass::m_pNumSpotLightCommandsBuffer");
		...
		m_pSpotLightCommandBuffer = new Buffer(pRenderEnv, pRenderEnv->m_pDefaultHeapProps, &spotLightCommandBufferDesc,
			pParams->m_InputResourceStates.m_SpotLightCommandBufferState, L"CreateTiledShadowMapCommandsPass::m_pSpotLightCommandBuffer");
	}
...
void CreateTiledShadowMapCommandsPass::InitRootSignature(InitParams* pParams)
{
	...
	m_pRootSignature = new RootSignature(pParams->m_pRenderEnv->m_pDevice, &rootSignatureDesc, L"CreateTiledShadowMapCommandsPass::m_pRootSignature");
}

void CreateTiledShadowMapCommandsPass::InitPipelineState(InitParams* pParams)
{
	...
	Shader computeShader(L"Shaders//CreateTiledShadowMapCommandsCS.hlsl", "Main", "cs_5_0", shaderDefines);

	ComputePipelineStateDesc pipelineStateDesc;
	pipelineStateDesc.SetRootSignature(m_pRootSignature);
	pipelineStateDesc.SetComputeShader(&computeShader);

	m_pPipelineState = new PipelineState(pRenderEnv->m_pDevice, &pipelineStateDesc, L"CreateTiledShadowMapCommandsPass::m_pPipelineState");
}

void CreateTiledShadowMapCommandsPass::InitCommandSignature(InitParams* pParams)
{
	...
	m_pCommandSignature = new CommandSignature(pRenderEnv->m_pDevice, nullptr, &commandSignatureDesc, L"CreateTiledShadowMapCommandsPass::m_pCommandSignature");
}

void CreateTiledShadowMapCommandsPass::AddResourceBarrierIfRequired(GraphicsResource* pResource, D3D12_RESOURCE_STATES currState, D3D12_RESOURCE_STATES requiredState)
{
