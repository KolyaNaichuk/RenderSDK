	...
	, m_pPipelineState(nullptr)
{
	...
	m_pRootSignature = new D3DRootSignature(pRenderEnv->m_pDevice, &rootSignatureDesc, L"VisualizeMeshRecorder::m_pRootSignature");
	...
	m_pPipelineState = new D3DPipelineState(pRenderEnv->m_pDevice, &pipelineStateDesc, L"VisualizeMeshRecorder::m_pPipelineState");
	*/
}
