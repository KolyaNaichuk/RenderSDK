	...
	, m_pCommandSignature(nullptr)
{
	...
	m_pRootSignature = new D3DRootSignature(pRenderEnv->m_pDevice, &rootSignatureDesc, L"FillGBufferRecorder::m_pRootSignature");
	...
	m_pPipelineState = new D3DPipelineState(pRenderEnv->m_pDevice, &pipelineStateDesc, L"FillGBufferRecorder::m_pPipelineState");
